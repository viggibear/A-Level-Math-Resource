...
\begin{outline}[enumerate]
 ...
 \2 Given instead that Jill spends \$ \(k\) at the start of every month including January, find the greatest value of \$ \(k\) such that she can afford a \$25,000 car at the end of 2020. \hfill[3]
 ...
 \2 Find the sum of the series \(\sin{2x}+\sin{4x}+\dots+\sin{2nx}\).\hfill[4]%Question 9
