...
\1 It is given that $y=\sqrt[3]{(1+x^2)(1+4x^2)}$. %Question 2
  ...
  \2 Hence, show that $\frac{91487}{90000}$ is an accurate estimate for $\sqrt[3]{1.0504}$  up to 4 decimal places.\hfill[2]
...
\1 Find the first three non-zero terms in the expansion of $()
