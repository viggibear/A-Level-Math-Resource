...
\begin{outline}[enumerate]
 ...
 \begin{answer}
   ...
   \end{align*}
 \end{answer}
 Hence, obtain the first three terms in the Maclaurin's series for \(y\).\hfill[3] %Question 4
 \begin{answer}
 ...
 \1 Given that \(\tan{2x}=a_{0}+a_{1}x+a_{2}x^2+a_{3}x^3\dots \), by using the fact that \(\sin{2x}=\cos{2x}\cdot \tan{2x}\), obtain the expansion of \(\tan{2x}\) in ascending powers of \(x\), up to and including the term in \(x^3\).\hfill[4] %Question 6
 \begin{answer}
